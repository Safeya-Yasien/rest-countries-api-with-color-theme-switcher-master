...
const CountryDetailsPage = () => {
  ...
  return (
    <div className="text-black dark:text-white py-6">
      ...
      {/* Don't show details until loaded successfully */}
      {loading !== "pending" && !error && country && (
      ...
      {/* Final fallback if country is still not available and not loading */}
      {loading !== "pending" && !country && !error && (
